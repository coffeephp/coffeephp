<div class="blog-pages">
    <div class="col-md-12 panel">
        <div class="panel-body">
            ...
            <hr>
            <form method="POST" action="{{ url('articles') }}" accept-charset="UTF-8" id="article-create-form">
                ...
                <div class="form-group">
                    <textarea required="require" class="form-control" rows="20" style="overflow:hidden" id="reply_content" placeholder="请使用 Markdown 格式书写 ;-)，代码片段黏贴时请注意使用高亮语法。" name="body_original" cols="50"></textarea>
                </div>
