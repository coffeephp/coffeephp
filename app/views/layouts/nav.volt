    ...
    <div class="container">
        ...
        <div id="top-navbar-collapse" class="navbar-collapse">
            <ul class="nav navbar-nav">
                {#<li class="{%  if controllerName == 'index' %}active{% endif %}"><a href="{{ url('/') }}">首页</a></li>#}
                {#<li class="{%  if controllerName == 'shares' %}active{% endif %}"><a href="{{ url('shares') }}">分享</a></li>#}
{#                <li class="{%  if controllerName == 'shares' %}active{% endif %}"><a href="{{ url('/') }}">首页</a></li>#}
                ...
                <li class="{%  if controllerName == 'sites' %}active{% endif %}"><a href="{{ url('sites') }}">酷站</a></li>
            </ul>
